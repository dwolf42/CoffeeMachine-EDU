...
public class DisplayMessages {
    ...
    public final String ADD_WATER = "Input how many ml of water you want to add: ";
    public final String ADD_MILK = "Input how many ml of milk you want to add: ";
    public final String ADD_BEANS = "Input how many grams of coffee beans you want to add: ";
    public final String ADD_CUPS = "Input how many disposable cups of coffee you want to add: ";
